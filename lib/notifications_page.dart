...
class AppColors {
  static const Color primary = Color(0xff00aaed); // Soft neon purple
  static const Color accent = Color(0xFFFFC107); // Gold accent
  static const Color background = Color(0xffdddec4); // True dark
  static const Color card = Color(0xffffffff); // Dark surface
  static const Color textDark = Color(0xff000000); // White text
  static const Color textLight = Color(0xff0e0e0e); // Greyed text
}
