...
// Add your Cloudinary credentials
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    Color(0xffa8e6ff), // light sky blue
                    Color(0xffdff7ff), // soft white-blue
                  ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFDEDDC4), // Light blue background
      body: SafeArea(
              ...
              SizedBox(
                ...
                child: Stack(
                  children: [
                    ...
                    Container(
                      decoration: const BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage("assets/hero_tours.jpg"),
                          fit: BoxFit.cover,
                        ),
                      ),
                      child: Container(
                    ...
                    // 🧊 GLASSMORPHIC SEARCH BAR (Overlay, Top)
                    Positioned(
                      top: 14,
                      left: 16,
                      right: 16,
                        ...
                        child: BackdropFilter(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    "Search activities, places or categories...",
                                hintStyle: TextStyle(
...
class TopCenterFabLocation extends FloatingActionButtonLocation {
  ...
  Offset getOffset(ScaffoldPrelayoutGeometry g) {
    ...
    return Offset(
      ...
      // place above bottom nav bar / safe area
      g.contentBottom - g.floatingActionButtonSize!.height - margin,
    );
  }
}
